module github.com/super-saga/go-x/messaging

go 1.23.1

require (
	bitbucket.org/Amartha/go-x/log v1.1.2
...
require (
	...
	github.com/super-saga/go-x/graceful v0.0.0-20250130160153-1656c5dfc4ed
